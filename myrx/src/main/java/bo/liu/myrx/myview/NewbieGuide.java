...
public class NewbieGuide {
    ...
    private ArrayList<HoleBean> mHoleList;
    ...
    private TextView generateMsgTv(String msg) {
        ...
        msgTv.setLineSpacing(CommonUtil.dpToPx(mActivity, 5), 1f);
    ...
    private TextView generateKnowTv(String text) {
        ...
        knowTv.setPadding(CommonUtil.dpToPx(mActivity, 15), CommonUtil.dpToPx(mActivity, 5), CommonUtil.dpToPx(mActivity, 15),
                CommonUtil.dpToPx(mActivity, 5));
    ...
    private LinearLayout generateMsgAndKnowTv(String msg) {
        ...
        lp.topMargin = CommonUtil.dpToPx(mActivity, 10);
    ...
    public void show() {
        int paddingTop = CommonUtil.getStatusBarHeight(mActivity);
