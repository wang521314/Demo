...
public class GuideView extends RelativeLayout {
    ...
    private void init() {
        pdf = new PorterDuffXfermode(PorterDuff.Mode.CLEAR);//PorterDuffXfermode元素混合
        mPaint = new Paint();
    ...
    public void setDate(List<HoleBean> holeList) {
        ...
        mStrokeWidth = Math.max(Math.max(mBitmapRect.left, mBitmapRect.top), Math.max(CommonUtil.getScreenWidth(getContext()) -
                mBitmapRect.right, CommonUtil.getScreenHeight(getContext()) - mBitmapRect.bottom));
